== Spring Data Commons for CDI

Distribution of Spring Data Commons with minimal changes for better CDI integration.
...
== Maven dependencies
		...
		<dependency>
			<groupId>com.github.arielcarrera.data</groupId>
			<artifactId>spring-data-commons-cdi</artifactId>
			<version>2.2.1.CDI.1</version>
		</dependency>
